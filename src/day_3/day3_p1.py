...
assert min(wire3.manhattan_distance(value) for value in intersection_cords2[1:]) == 159
...
assert min(wire5.manhattan_distance(value) for value in intersection_cords3[1:]) == 135
...
print(min(real_wire1.manhattan_distance(value) for value in real_intersections[1:]))
