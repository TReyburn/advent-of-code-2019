...
assert min(value['step'] + value['f_step'] for value in intersection_cords1[1:]) == 30
...
assert min(value['step'] + value['f_step'] for value in intersection_cords2[1:]) == 610
...
assert min(value['step'] + value['f_step'] for value in intersection_cords3[1:]) == 410
...
print(min(value['step'] + value['f_step'] for value in real_intersections[1:]))
