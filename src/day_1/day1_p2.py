...
from fuel_funcs import fuel_calc_v2, fuel_counter_upper_v2


def main(file: str) -> int:
    assert fuel_calc_v2(14) == 2
    assert fuel_calc_v2(1969) == 966
    assert fuel_calc_v2(100756) == 50346

    print(fuel_counter_upper_v2(file))
    return fuel_counter_upper_v2(file)
